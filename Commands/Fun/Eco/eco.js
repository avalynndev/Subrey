...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((options) =>
      options.setName("chopwood").setDescription("chop wood in the forest and get some coins")
    )
    .addSubcommand((options) =>
      options.setName("fish").setDescription("catch some fish and get some coins")
    )
    .addSubcommand((options) =>
      options.setName("hunt").setDescription("hunt some animals and get some coins")
    )
    .addSubcommand((options) =>
