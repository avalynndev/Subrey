...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const msgRef = await interaction.reply({ embeds: [thinkembed] });
    ...
    wyr().then((response) => {
      const embed = new Discord.EmbedBuilder()
        ...
        .setFooter({
          ...
          iconURL:
            "https://media0.giphy.com/media/UtKfCyc9fAzvcJc1Ie/200w.gif?cid=82a1493b7mu1u4jbu2t8mtdozq033rdq8kmc4fttrljj0tpu&rid=200w.gif&ct=g",
        });
      ...
      msgRef.editReply({ embeds: [embed], components: [row] });
    });
  },
};
